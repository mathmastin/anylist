...
class Recipe {
   ...
   */
	async performOperation(handlerId) {
		...
		op.setRecipeDataId(this.recipeDataId || this._client.recipeDataId);
		if (!this.recipeDataId && this._client.recipeDataId) {
			this.recipeDataId = this._client.recipeDataId;
		}
